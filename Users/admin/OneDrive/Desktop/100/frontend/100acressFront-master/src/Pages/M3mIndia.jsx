...
const M3mIndia = () => {
  const { m3mIndia } = useContext(DataContext);
  return (
    <div>
      <Helmet>
        <title>
          M3M SCO Plots for Sale in Gurugram
        </title>
        <meta
          name="description"
        ...
        />
         <link
          rel="canonical"
          href="https://www.100acress.com/m3m-india-sco-plots-gurugram/"
        />
      </Helmet>
