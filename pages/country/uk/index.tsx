...
const UKHomePage: NextPage<UKHomePageProps> = ({ country }) => {
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://100acress.com/country/uk`} />
        <meta property="og:image" content={`https://100acress.com/images/uk-real-estate.jpg`} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={country.seo.title} />
        <meta name="twitter:description" content={country.seo.description} />
        <meta name="twitter:image" content={`https://100acress.com/images/uk-real-estate.jpg`} />
        <link rel="canonical" href={`https://100acress.com/country/uk`} />
      </Head>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg" style={{ color: 'var(--text-secondary, #4a5568)' }}>
                Discover our handpicked selection of premium UK properties
              </p>
            </motion.div>
              ...
              {[1, 2, 3, 4, 5, 6].map((item) => (
                ...
                >
                  <div 
                    ...
                    style={{ 
                      backgroundImage: `url('/images/properties/uk-${item}.jpg')`,
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-2xl font-bold" style={{ color: 'var(--accent-primary, #1e40af)' }}>
                        {country.currencySymbol}{(500000 + item * 100000).toLocaleString()}
                      </span>
                      <Link
                        href={`/properties/uk/${item}`}
...
export const getStaticProps: GetStaticProps<UKHomePageProps> = async () => {
  const country = getCountryByCode('uk');
