              ...
              {cities.slice(1, 3).map((city, index) => (
                ...
                >
                  ...
                  <div className="absolute top-4 left-4">
                    <span className={`px-3 py-1 text-xs font-bold rounded-full ${city.type === 'Ultra Luxury' ? 'bg-gradient-to-r from-purple-600 to-pink-600' :
            ...
            {cities.slice(3, 5).map((city, index) => (
              ...
              >
                ...
                <div className="absolute top-5 left-5">
                  <span className={`px-3 py-1 text-xs font-bold rounded-full ${city.type === 'Emerging' ? 'bg-gradient-to-r from-green-500 to-emerald-600' :
