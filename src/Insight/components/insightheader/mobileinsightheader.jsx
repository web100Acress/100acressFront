            ...
            <header className="fixed top-0 left-0 right-0 z-[1001] bg-gradient-to-r from-white via-gray-50 to-white backdrop-blur-md border-b border-gray-200 shadow-lg transition-all duration-300">
                <div className="h-16 flex items-center justify-between px-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Link to="/real-estate-insights" className="group">
                    ...
                    >
                        ...
                        <button
                            ...
                            className="p-2.5 text-gray-600 hover:text-[#e53e3e] hover:bg-red-50 rounded-xl relative transition-all duration-200 active:scale-95 shadow-sm hover:shadow-md"
                        >
