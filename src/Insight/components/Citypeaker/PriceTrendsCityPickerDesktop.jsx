...
export default function PriceTrendsCityPickerDesktop({
  compareMode,
  setCompareMode,
  selectedCities,
  setSelectedCities,
  ...
  useEffect(() => {
    const updateScreenSize = () => {
      ...
      // Sidebar width baseline is 240px
      const availableWidth = width - 240;

      if (availableWidth < 640) {
        setScreenSize("sm-desktop");
        setPerPage(10);
        setGridCols(2);
  ...
  const renderCard = (city) => {
    ...
    return (
      <div
        key={cname}
        className={`group relative transition-all duration-300 ease-out transform ${isHovered ? "scale-105" : "scale-100"
          }`}
      ...
      >
        <button
          ...
          className={`relative w-full bg-white border-2 rounded-xl sm:rounded-2xl p-2 sm:p-3 lg:p-4 text-left shadow-lg hover:shadow-2xl transition-all duration-300 ease-out flex flex-col items-center gap-1 sm:gap-2 lg:gap-3 group-hover:border-blue-300 ${isSelected
        ...
        >
          ...
          <div className="relative inline-flex w-12 h-12 sm:w-16 sm:h-16 lg:w-24 lg:h-24 rounded-full overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 shadow-inner ring-2 sm:ring-4 ring-white">
            {!hasError && imageUrl ? (
              <img
                key={imageUrl}
                alt={cname}
          ...
          <div className="text-center space-y-0.5 sm:space-y-1">
            <h3 className="font-bold text-xs sm:text-base lg:text-lg text-gray-900 group-hover:text-blue-700 transition-colors duration-200">
              {cname}
            </h3>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/30">
      <div className="w-full px-4 lg:px-6">
        ...
        <div className="mb-4 sm:mb-6">
          <div className="relative overflow-hidden rounded-xl sm:rounded-2xl shadow-lg border border-gray-100">
            <img
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-slate-900/80 via-slate-900/40 to-transparent flex items-center">
              <div className="px-6 sm:px-10 lg:px-16 text-white text-left max-w-3xl">
                <h2 className="text-xl sm:text-2xl lg:text-4xl font-bold mb-2 lg:mb-3 tracking-tight leading-tight">
                  Real Estate
                  <span className="block text-blue-400">Market Insights</span>
                </h2>
                <p className="text-xs sm:text-sm lg:text-base opacity-90 font-medium leading-relaxed max-w-md">
                  Explore property rate trends, luxury home valuations, and investment analytics across India's premier destinations.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mb-4 sm:mb-6 bg-white border-2 border-gray-200 rounded-xl sm:rounded-2xl shadow-sm p-2 sm:p-2.5">
          <div className="flex flex-wrap gap-2 sm:gap-3">
            {popularChips.map((chip) => (
              <button
                ...
                className="px-2.5 py-1 sm:px-4 sm:py-1.5 rounded-full border-2 border-gray-200 bg-white text-[10px] sm:text-xs font-medium text-gray-700 hover:bg-blue-50 hover:border-blue-300 hover:text-blue-700 transition-all duration-200 shadow-sm hover:shadow-md transform hover:scale-105"
        ...
        {pickerLoading ? (
          <div className="space-y-8">
            <div
              className={`grid gap-4 sm:gap-6 ${gridCols === 1
                ? "grid-cols-1"
                : gridCols === 2
                  ? "grid-cols-2"
                  : gridCols === 3
          ...
          <div className="space-y-6 sm:space-y-8">
            <div className="mt-6">
                ...
                <div className="relative">
                  <div className="flex gap-6 sm:gap-8 overflow-x-auto pb-4 scrollbar-hide justify-start min-h-[200px]">
                    {[
                      ...
                      >
                        <div className={`relative bg-gradient-to-br from-white via-gray-50 to-white rounded-xl p-2 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-110 hover:-translate-y-2 border border-gray-200 hover:border-purple-300 overflow-hidden w-32 sm:w-36 ${index >= 5 ? 'mr-6' : ''}`}>
                          <div
                          ...
                          <div className="mt-5 text-center relative z-10">
                            <h3 className="text-xs sm:text-sm font-bold text-gray-800 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-purple-600 group-hover:to-pink-600 transition-all duration-300 leading-tight">
                              {story.title}
                            </h3>
                            <p className="text-[10px] sm:text-xs text-gray-600 group-hover:text-gray-700 mt-1.5 leading-tight font-medium">
                              {story.subtitle}
                            </p>
              ...
              <div className="mb-4 sm:mb-6">
                <div className="flex items-center justify-between">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-extrabold tracking-tight text-gray-900">
                    Popular Cities
                  </h2>
                  <label
                    className={`${compareMode
                      ...
                      } inline-flex items-center gap-1.5 sm:gap-2 text-[10px] sm:text-xs font-semibold px-2 py-1 sm:px-3 sm:py-1.5 rounded-lg border-2 transition-all cursor-pointer ml-4`}
                  >
                    <input
                      type="checkbox"
                      checked={compareMode}
                      ...
                      className="w-3.5 h-3.5 sm:w-4 sm:h-4 rounded text-blue-600 focus:ring-blue-500 focus:ring-2"
                    />
                    <svg
            ...
            {cityCategories.map((category, index) => (
              <section key={category.id || index}>
                ...
                <div
                  className={`grid gap-3 sm:gap-4 ${gridCols === 1
                    ? "grid-cols-1"
                    : gridCols === 2
                      ? "grid-cols-2"
                      : gridCols === 3
        ...
        {!pickerLoading && visibleCities && !expanded && (
          <div className="flex items-center justify-center mt-8">
            <button
              ...
              className="px-6 py-2.5 rounded-xl border-2 border-gray-300 bg-white hover:bg-gray-50 text-base font-semibold text-gray-700 hover:text-gray-900 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105"
            >
              View More Cities
            </button>
          </div>
        ...
        {compareMode && (
          <div className="flex fixed bottom-4 right-4 lg:right-6 z-50">
            <div className="flex items-center gap-3 lg:gap-4 bg-white border-2 border-gray-200 shadow-2xl rounded-xl pl-4 lg:pl-6 pr-2 lg:pr-3 py-2 lg:py-3 backdrop-blur-sm">
              ...
              <button
                ...
                className={`px-4 py-2 lg:px-6 lg:py-3 rounded-xl text-xs lg:text-sm font-bold transition-all duration-200 ${selectedCities.length < 2
        ...
        {selectedStory && (
          <div
            className="fixed inset-0 bg-red-950 bg-opacity-90 flex items-center justify-center z-[1100] p-4"
