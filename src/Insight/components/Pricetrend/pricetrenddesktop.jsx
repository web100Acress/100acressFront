                    ...
                    <>
                        {compareMode && selectedCities.length >= 2 ? (
                            ...
                            <>
                                ...
                                <div className="relative w-full h-40 sm:h-60 md:h-72 lg:h-80 overflow-hidden mb-6 rounded-2xl shadow-xl border border-gray-100">
                                    ...
                                    <div className="relative z-10 flex items-center h-full px-6 sm:px-10 lg:px-16">
                                        <div className="text-left max-w-3xl">
                                            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-2 lg:mb-3 tracking-tight leading-tight">
                                                Property Rate Trends in
                                                <span className="block text-blue-400">
                                                    {city}
                                                </span>
                                            </h1>
                                            <p className="text-xs sm:text-sm lg:text-base text-gray-100 mb-4 sm:mb-6 max-w-md leading-relaxed font-medium opacity-90">
                                                Get accurate market analytics, price movements, and investment yields for {city}.
                                            </p>

                                            {/* Action Buttons - Left Aligned */}
                                            <div className="flex flex-row items-center gap-3 sm:gap-4">
                                                <button
                                                    onClick={() => { setShowPicker(true); setCompareMode(false); }}
                                                    className="px-5 py-2 sm:px-6 sm:py-2.5 bg-white/10 backdrop-blur-md text-white font-semibold rounded-xl hover:bg-white hover:text-gray-900 transition-all duration-300 border border-white/30 shadow-lg text-sm md:text-base flex items-center gap-2"
                                                >
                                                ...
                                                <button
                                                    onClick={downloadCSV}
                                                    className="px-5 py-2 sm:px-6 sm:py-2.5 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-all duration-300 shadow-lg text-sm md:text-base flex items-center gap-2"
                                                >
                                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
