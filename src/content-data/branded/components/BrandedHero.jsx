...
export default function BrandedHero({ 
  ...
  onContact, 
  onSearch, 
  title = 'Branded Residences in India', 
  subtitle = ' ',
  onFilterChange,
  filters = {}
}) {
  // Enhanced background with gradient overlay (same as original Hero)
  ...
  return (
    <section className="relative w-full min-h-[30vh] flex flex-col items-center mt-16 bg-gradient-to-br from-red-600 via-red-700 to-red-800">
      <Helmet>
        <title>Branded Residences in India | Luxury Homes by Global Brands</title>
        <meta name="description" content="Explore branded residences in prime locations, like Gurugram and Noida, where developers collaborate with global brands, creating luxury homes with premium amenities." />
      </Helmet>
      ...
      {/* Branded Residences Description Section */}
