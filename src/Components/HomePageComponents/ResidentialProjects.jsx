...
const ResidentialProjects = () => {
  ...
  // Update filtered data when residencialProjects changes
  useEffect(() => {
    if (residencialProjects && residencialProjects.length > 0) {
      setFilteredData(residencialProjects);
      // Debug: Log first few projects to see their structure
      console.log('Residential Projects Data Sample:', residencialProjects.slice(0, 3));
    }
  }, [residencialProjects]);

  // Filter data based on search and filters
  const applyFilters = () => {
    if (!residencialProjects) return;

    let filtered = residencialProjects.filter(project => {
      // Search filter
  ...
  useEffect(() => {
    applyFilters();
  }, [searchTerm, selectedCities, selectedProjectStatus, minPrice, maxPrice, residencialProjects]);
  ...
  // Filter options
  const cities = [
    "Gurugram", "Delhi", "Noida", "Goa", "Mumbai"
  ];
          ...
          <div className="relative text-center py-6 mb-4 px-2">
            ...
            <div className="relative z-10 max-w-5xl mx-auto pt-4">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-3 tracking-wide leading-tight" style={{ fontFamily: 'DM Sans, sans-serif' }}>
                ...
                <span className="text-gray-900 drop-shadow-sm"> Property</span>
              </h1>
              ...
              Residential properties range from homes to apartments, each crafted to match unique lifestyles and comfort needs.
            ...
            <main className="flex-1 min-w-0">
              ...
              <div className="mb-2">
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="Search residential projects by name or city..."
                    value={searchTerm}
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-2">
                <div className="text-gray-700 font-semibold flex-shrink-0">Showing {filteredData.length} Residential Properties</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                {filteredData.length === 0 ? (
                  <div className="col-span-full text-center py-10">
                    <h2 className="text-xl font-semibold text-gray-600">No residential properties found</h2>
                    ...
                    >
                      ...
                      <div className="flex flex-col flex-1 p-4">
                        ...
                        <div className="flex items-center gap-2 text-sm text-gray-600 mb-4">
                          ...
                          <span className="truncate">{project.type || project.propertyType || 'Residential Property'}</span>
                        </div>
