...
//     >
//       <div className="SJDMls  xl:h-14 lg:h-14 md:h-8 sm:h-8 mt-[170px] lg:mt-[270px] xl:mt-[330px]">
//         {["Buy", "Rent", "New Launch", "Commercial", "Land/Plots", "SCO"].map(
//           (linkName) => (
//             <Link
//               key={linkName}
//               className={`options font-semibold hover:underline hover:underline-offset-8 cursor-pointer whitespace-nowrap ${
//                 activeLink === linkName
