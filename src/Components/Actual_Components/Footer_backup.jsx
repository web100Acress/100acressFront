          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="rounded-2xl p-8 transition-all duration-300" style={{backgroundColor: '#680101'}}>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Link to="/global/projects-in-dubai-uae/" className="text-white hover:text-white hover:underline transition-all duration-200 text-sm px-3 py-1 rounded-full" style={{backgroundColor: '#8D0101'}}>Flats in Dubai</Link>
              </div>
            </div>
