...
function RentPropViewCard() {
  ...
  return (
    ...
    <Nav />
    <Helmet>
        <title>best-rental-property-in-gurugram</title>
        <meta
          name="description"
          content="Discover the best rental properties in Gurugram. Find your ideal property in gurugram only by 100acress.com"
        />
      </Helmet>
    <div>
