        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold">acress</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Your trusted partner in international real estate. We help you find 
              the perfect property across the UK, USA, Sri Lanka, and beyond.
            </p>
          ...
          {/* Countries Column */}
          <div>
            <h3 className="text-lg font-bold mb-6 text-amber-400">Countries</h3>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link to="/country/choose" className="text-gray-400 hover:text-amber-400 transition-colors">
                  Choose Country
                </Link>
              </li>
              <li>
                <Link to="/global/projects" className="text-gray-400 hover:text-amber-400 transition-colors">
                  All Projects
                </Link>
              </li>
              <li>
                <Link to="/global/about" className="text-gray-400 hover:text-amber-400 transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/global/contact" className="text-gray-400 hover:text-amber-400 transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-lg font-bold mb-6 text-amber-400">Global Contact</h3>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-400 text-sm">Global Hotline</p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold">global@100acress.com</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 mt-0.5 text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold">Global Operations Center</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} 100acress Global. All rights reserved.
            </p>
