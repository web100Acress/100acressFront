...
const SriLankaHero: React.FC = () => {
  ...
  return (
    <section 
      ...
      style={{ 
        background: `linear-gradient(135deg, var(--accent-primary, #ea580c) 0%, var(--accent-secondary, #f97316) 100%)` 
      }}
    >
      {/* Background Pattern */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Find Your Dream
              <br />
              <span className="text-amber-300">Property in Sri Lanka</span>
            </h1>
            
            <p className="text-xl text-orange-100 mb-8 leading-relaxed">
              Discover beautiful properties across Sri Lanka. From Colombo's modern 
              apartments to beach villas, find your perfect home with 
              100acress Sri Lanka.
            </p>
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <div className="text-orange-100 text-sm">Properties</div>
              </div>
              <div className="text-center">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <div 
                ...
                style={{ 
                  backgroundImage: `url('/images/srilanka-property-hero.jpg')`,
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="font-bold text-gray-900">Colombo Beach Villa</div>
                    <div className="text-2xl font-bold text-orange-600">රු 45,000,000</div>
                  </div>
                  <Link
                    href="/properties/colombo-beach-villa"
