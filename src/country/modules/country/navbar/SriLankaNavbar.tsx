        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center space-x-2">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs font-semibold" style={{ color: 'var(--accent-primary, #ea580c)' }}>
                {currentCountry?.shortName || 'SL'}
              </span>
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link
              ...
              style={{ 
                borderColor: 'var(--accent-primary, #ea580c)',
                color: 'var(--accent-primary, #ea580c)'
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.backgroundColor = 'var(--accent-primary, #ea580c)';
                e.currentTarget.style.color = 'var(--accent-text, #ffffff)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.backgroundColor = 'transparent';
                e.currentTarget.style.color = 'var(--accent-primary, #ea580c)';
              }}
            >
              <span>🌍</span>
              <span>Global</span>
            ...
            <button
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.backgroundColor = 'var(--accent-secondary, #f97316)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.backgroundColor = 'var(--accent-primary, #ea580c)';
              }}
