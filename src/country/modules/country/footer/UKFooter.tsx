        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              Your trusted partner for UK real estate. Find premium properties across 
              the United Kingdom with expert guidance and secure transactions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/properties" className="text-gray-400 hover:text-blue-400 transition-colors">Properties</Link></li>
              ...
              <li><Link href="/country/choose" className="text-gray-400 hover:text-blue-400 transition-colors">🌍 Global</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">{currentCountry?.contact.phone || '+44 20 7123 4567'}</span>
              </div>
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 mt-0.5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-400">{currentCountry?.contact.email || 'uk@100acress.com'}</span>
              </div>
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 mt-0.5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-400">{currentCountry?.contact.address || '100acress UK, 123 London Street, London, UK, SW1A 1AA'}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 100acress {currentCountry?.shortName || 'UK'}. All rights reserved.
            </p>
