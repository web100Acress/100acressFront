...
const Blog = lazy(() => import("./Components/Blog_Components/Blog/admin/desktop/Blog"));
...
const BlogEdit = lazy(() => import("./Components/Blog_Components/Blog/admin/desktop/BlogEdit"));
const BlogWrite = lazy(() => import("./Components/Blog_Components/Blog/admin/desktop/BlogWrite"));
// const BlogWriteModal = lazy(() => import("./Components/Blog_Components/Blog/admin/desktop/BlogWriteModal"));
...
const BlogViewAdmin = lazy(() => import("./Components/Blog_Components/Blog/admin/desktop/BlogViewAdmin"));
// const BlogEnquiries = lazy(() => import("./AdminPage/BlogEnquiries"));
const OtherEnquiries = lazy(() => import("./AdminPage/OtherEnquiries"));
const SeoPrivateRoute = lazy(() => import("./Components/Blog_Components/Blog/create/desktop/SeoPrivateRoute"));
const BlogManagement = lazy(() => import("./Components/Blog_Components/Blog/create/desktop/BlogManagement"));
const BlogDashboard = lazy(() => import("./Components/Blog_Components/Blog/create/desktop/BlogDashboard"));
const DraftManagement = lazy(() => import("./Components/Blog_Components/Blog/create/desktop/DraftManagement"));
const BlogManagementSidebar = lazy(() => import("./Components/Blog_Components/Blog/create/desktop/BlogManagementSidebar"));
...
import UkPage from "./Pages/country/uk/UkPage";
                ...
                <Suspense fallback={<LoadingSpinner />}>
                  ...
                  <Routes>
                    <Route element={<PublicRoute />}>
                      ...
                      <Route path="/united-arab-emirates/" element={<UsaPage />} />
                      ...
                      <Route path="/global/projects-in-london-uk/" element={<UkPage />} />
                      <Route path="/global/projects-in-srilanka/" element={<SriLankaPage />} />
                      ...
                      <Route path="/country/uk/" element={<UkPage />} />
