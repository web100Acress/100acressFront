    ...
    return (
        <>
            <Helmet>
                ...
                <meta property="og:title" content="Customer Testimonials | 100acress.com Reviews" />
                <meta property="og:description" content="Read genuine customer testimonials and reviews for 100acress.com. 98% client satisfaction rate. Discover why we're the trusted real estate partner in Delhi NCR." />
                <meta property="og:image" content="https://www.100acress.com/Images/mainbg.webp" />
                
                {/* Twitter */}
                <meta property="twitter:card" content="summary_large_image" />
                <meta property="twitter:url" content="https://www.100acress.com/testimonials/" />
                <meta property="twitter:title" content="Customer Testimonials | 100acress.com Reviews" />
                <meta property="twitter:description" content="Read genuine customer testimonials and reviews for 100acress.com. 98% client satisfaction rate." />
                <meta property="twitter:image" content="https://www.100acress.com/Images/mainbg.webp" />
                ...
                <script type="application/ld+json">
                    {JSON.stringify({
                        ...
                        "logo": "https://www.100acress.com/Images/mainbg.webp",
                        "sameAs": [
                            "https://www.facebook.com/100acress",
                            "https://twitter.com/100acress",
                            "https://www.linkedin.com/company/100acress",
                            "https://www.instagram.com/100acress"
                        ],
                        "aggregateRating": {
                    ...
                    {JSON.stringify({
                        ...
                        "itemListElement": [
                            ...
                            },
                            {
                                ...
                                "position": 2,
                                "name": "Testimonials",
                                "item": "https://www.100acress.com/testimonials/"
                            }
                        ]
                    })}
                </script>
                ...
                <script type="application/ld+json">
                    {JSON.stringify({
                        ...
                        "mainEntity": [
                            {
                                "@type": "Question",
                                "name": "What is the client satisfaction rate at 100acress.com?",
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "100acress.com maintains a 98% client satisfaction rate, making us one of the best real estate consultants in Delhi NCR."
                                }
                            },
                            {
                                "@type": "Question",
                                "name": "Why should I choose 100acress.com for buying property in Delhi NCR?",
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "100acress.com offers transparent dealings, honest advice, and personalized property solutions. We provide verified projects only and have helped thousands of happy homeowners find their dream properties."
                                }
                            },
                            {
                                "@type": "Question",
                                "name": "Does 100acress.com operate in Gurgaon, Noida, and Delhi?",
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "Yes, 100acress.com operates across Delhi NCR including Gurgaon, Noida, Delhi, and other major cities. We offer residential and commercial properties with complete documentation support."
                                }
                            }
                        ]
                    })}
