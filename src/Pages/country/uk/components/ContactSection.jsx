  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        projectName: `UK Property Inquiry - ${formData.propertyType || 'General'}`,
        address: `Budget: ${formData.budget || 'Not specified'} | Message: ${formData.message.trim() || 'No message'}`,
        source: "uk_luxury_page",
      };

      const response = await api.post("/userInsert", payload);
      
      toast.dismiss(loadingToast);
      toast.success("Thank you! Our UK property expert will contact you shortly.", {
        duration: 5000,
      });
          ...
          <div className="space-y-6 lg:space-y-8 animate-fade-in">
            <div>
              ...
              <p className="text-sm sm:text-base lg:text-xl text-muted-foreground">
                Connect with our UK property experts for personalized assistance
              </p>
            </div>
          ...
          <div className="animate-fade-in-scale">
            <form onSubmit={handleSubmit} className="glass-effect rounded-2xl border border-white/10 p-8 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-white">Budget Range (GBP)</label>
