...
export const Header = () => {
  ...
  const navLinks = [
    { name: "USA Properties", href: "#properties" },
    ...
    >
      <div className="container flex items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          <a href="/country/usa/" className="flex items-center space-x-2 sm:space-x-3">
            <img 
              src={LOGO}
              alt="100acress" 
              className="h-10 sm:h-14 md:h-16 w-auto object-contain"
            />
            <span className="hidden sm:block text-white font-bold text-lg sm:text-xl">100acress USA</span>
          </a>
          ...
          <div className="relative countries-dropdown hidden sm:block">
            ...
            >
              ...
              <span className="hidden md:inline">USA</span>
        ...
        <div className="hidden lg:flex items-center space-x-2 xl:space-x-4">
          <Button 
            ...
            onClick={() => window.open("https://wa.me/919811750740?text=Hi! I'm interested in USA properties. Can you help me?", "_blank")}
          >
