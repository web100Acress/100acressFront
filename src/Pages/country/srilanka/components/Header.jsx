...
export const Header = () => {
  ...
  const navLinks = [
    { name: "Sri Lanka Properties", href: "#properties" },
    ...
    >
      <div className="container flex items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          <a href="/country/srilanka/" className="flex items-center space-x-2 sm:space-x-3">
            <img 
              src={LOGO}
              alt="100acress" 
              className="h-10 sm:h-14 md:h-16 w-auto object-contain"
            />
            <span className="hidden sm:block text-white font-bold text-lg sm:text-xl">100acress Sri Lanka</span>
          </a>
          {/* Countries Dropdown */}
          ...
          {navLinks.map((link) => (
            <a
              ...
              className={cn(
                ...
                link.name === 'Sri Lanka Properties'
        ...
        <div className="hidden lg:flex items-center space-x-2 xl:space-x-4">
          <Button 
            ...
            onClick={() => window.open("https://wa.me/919811750740?text=Hi! I'm interested in Sri Lanka properties. Can you help me?", "_blank")}
          >
