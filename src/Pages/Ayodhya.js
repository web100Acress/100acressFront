...
const Ayodhya = () => {
  const { ayodhya } = useContext(DataContext);
  return (
    <div>
      <Nav />
      <Helmet>
        <title>
          Property in Ayodhya - Flats, Villas, House for Sale in Ayodhya
        </title>
        <meta
          name="description"
      ...
      <section className="flex pt-2 flex-col items-center">
        ...
        <h2 className="text-sm mb-4 text-center sm:text-xl md:text-xl lg:text-sm font-normal lg:mx-20 md:mx-10 mx-5 sm:mx-4">
          Ayodhya is transforming with major enterprises, including new housing
