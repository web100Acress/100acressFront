...
const EmaarIndia = () => {
  const { emaarIndia } = useContext(DataContext);
  return (
    <div>
      <Helmet>
        <title>
          Emaar India SCO Plots for Sale in Gurugram
        </title>
        <meta
          name="description"
        ...
        />
         <link
          rel="canonical"
          href="https://www.100acress.com/emaar-india-sco-plots-gurugram/"
        />
      </Helmet>
      ...
      <section className="flex pt-2 flex-col items-center mt-12">
        <h1 className="mb-3 p-3 text-center text-2xl sm:text-xl md:text-2xl lg:text-3xl text-red-600 font-bold">
          Emaar India SCO Plots in Gurugram
        </h1>
