...
const SearchData = () => {
  ...
  return (
    <div className="min-h-screen" style={{ background: "linear-gradient(to bottom, #f9fafb 0%, #ffffff 100%)" }}>
      ...
      <div className={`sticky top-[60px] z-30 bg-white/95 backdrop-blur-md border-b border-gray-200 ${showFilters ? "" : "h-0 md:h-auto overflow-hidden md:overflow-visible"}`}>
        <div className="py-3  md:max-w-7xl md:mx-auto md:px-4">
          {/* Filter Controls */}
                ...
                >
                  ...
                  <Link to={detailUrl} className="block relative h-40 overflow-hidden">
                    ...
                    <div className="absolute top-2 left-2">
                      <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-semibold bg-white text-gray-700 shadow-sm">
