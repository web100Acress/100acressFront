      ...
      >
        ...
        <div className="mt-6 pt-4 border-t border-gray-100 space-y-3">
          <motion.button
            ...
            className="w-full px-6 py-3 bg-white border-2 border-primaryRed text-primaryRed font-semibold rounded-2xl hover:bg-primaryRed flex items-center justify-center gap-2"
