...
//                                 <p className="font-medium text-md pt-2 px-3 text-black">
//                                   {amenity}
//                                 </p>
//                               </div>
//                             </div>
          ...
          <div className="mx-10">
            <div className="row align-items-start">
              <div className="col-lg-8 m-15px-tb">
                ...
                {/* <article className="article">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center border-b border-gray-100 w-full pb-2 mt-4">
                    <span className="text-lg text-red-500 min-w-[120px]">
                      Description:
                    </span>
