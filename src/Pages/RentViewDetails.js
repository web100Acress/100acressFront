                      ...
                      <div className="w-full">
                        <span className="text-md font-medium mt-2 sm:mt-0 sm:ml-2">
                          {isExpanded || !rentViewDetails.descripation
                            ...
                            : `${rentViewDetails.descripation.slice(
                                0,
                                100
                              )}...`}
                          {rentViewDetails.descripation && (
                      ...
                      otherImage.length > 0 && (
                        <>
                          ...
                          <button
                            ...
                            className="absolute top-1/2 right-5 transform -translate-y-1/2 text-white bg-black p-2 rounded-full z-10"
                          >
                            <GrNext />
                          </button>
                        </>
                            ...
                            <React.Fragment key={index}>
                              {item.postProperty
                                ...
                                .map((nestedItem, nestedIndex) => (
                                  <div
                                    key={nestedIndex}
                                    className="bg-orange-100 shadow-md mx-3 mt-4 mb-4"
                                  >
                                      ...
                                      <div className="col-lg-4 col-md-4 col-sm-12 col-12 m-0">
                                        ...
                                        nestedItem.frontImage.url ? (
                                          <img
                                            ...
                                            alt="frontImage"
                                            className="object-cover h-48 w-full rounded-l-lg"
                                          />
                                        ) : (
