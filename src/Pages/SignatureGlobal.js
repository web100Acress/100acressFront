    ...
    <div>
      ...
      <Helmet>
        ...
        />
         <link
          rel="canonical"
          href="https://www.100acress.com/signatureglobal-plots-gurugram/"
        />
      </Helmet>
      ...
      <section className="flex pt-2 flex-col items-center">
        ...
        Signature global Plots in Gurugram
        </h1>
        ...
        <div className="grid max-w-md  grid-cols-1 px-8 sm:max-w-lg md:max-w-screen-xl md:grid-cols-2 md:px-4 lg:grid-cols-4 sm:gap-4 lg:gap-4 w-full">
          {signatureglobal.map((item, index) => {
...
export default SignatureGlobal