    ...
    <div>
      ...
      <section className="flex pt-2 flex-col items-center mt-12">
        ...
        <h2 className="text-sm mb-4 text-center sm:text-xl md:text-xl lg:text-sm font-normal lg:mx-20 md:mx-10 mx-5 sm:mx-4">
          Noida is experiencing significant expansion thanks to new
          infrastructure projects. Projects in Noida are building modern
          business hubs, luxurious residences, and green spaces to help increase
          connectivity, living standards, and business opportunities.
        </h2>
