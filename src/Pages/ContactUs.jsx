  ...
  return (
    <div className="overflow-x-hidden min-h-screen bg-gradient-to-br from-red-50 via-red-100 to-red-200">
      ...
      <main className="container mx-auto px-4 py-16">
        {/* Hero Section */}
        <div className="text-center mb-16 pt-20 md:pt-8">
              ...
              <form onSubmit={handleInquirySubmitData} className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onBlur={() => setFocusedField('')}
                      className={`w-full px-4 py-3 rounded-xl border-2 transition-all duration-300 ${focusedField === 'mobile'
                        ? 'border-red-600 shadow-lg ring-2 ring-red-200 bg-white'
                        : 'border-red-200 hover:border-red-300 bg-white'
                        } focus:outline-none focus:ring-2 focus:ring-red-200`}
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    onBlur={() => setFocusedField('')}
                    className={`w-full px-4 py-3 rounded-xl border-2 transition-all duration-300 resize-none ${focusedField === 'message'
                      ? 'border-red-600 shadow-lg ring-2 ring-red-200 bg-white'
                      : 'border-red-200 hover:border-red-300 bg-white'
                      } focus:outline-none focus:ring-2 focus:ring-red-200`}
                ...
                <button
                  ...
                  className={`w-full py-3 px-6 rounded-xl font-bold transition-all duration-300 transform ${!isFormValid || isSubmitting
