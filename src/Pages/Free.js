    ...
    return (
        <div className='px-4 py-8 '>
            <div className='flex flex-col md:flex-row justify-between items-center w-full bg-blue-50 h-auto md:h-30 lg:px-10 md:px-10 sm:px-1 py-6 md:py-8 rounded-xl'>
                <div data-aos="flip-left" data-aos-delay="200" className='md:mr-4 flex-grow'>
                ...
                <div data-aos="flip-right" data-aos-delay="200" className='text-left md:text-left mt-4 md:mt-0 px-2 flex-shrink-0'>
