...
//                   <div className="article-title">
//                     <div className="flex flex-col sm:flex-row sm:items-center border-b border-gray-300 w-full pb-2">
...
//                     <div className="flex flex-col sm:flex-row sm:items-center border-b border-gray-300 w-full pb-2 mt-2">
//                       <span className="text-lg text-red-500 min-w-[120px]">
//                         Address:
//                       </span>
...
//                     <div className="flex flex-col sm:flex-row border-b border-gray-300 pb-2 mt-2">
//                       <span className="text-lg text-red-500 min-w-[120px]">
//                         Amenities:
//                       </span>
...
//                 <article className="article">
//                   <div className="flex flex-col sm:flex-row items-start sm:items-center border-b border-gray-300 w-full pb-2 mt-4">
//                     <span className="text-lg text-red-500 min-w-[120px]">
//                       Description:
//                     </span>
//                     <span className="text-xl font-medium mt-2 sm:mt-0 sm:ml-2">
//                       {rentViewDetails.descripation}
//                     </span>
//                   </div>
//                 </article>
...
//                             className="absolute top-1/2 left-5 transform -translate-y-1/2 bg-white text-gray-500 p-2 rounded-full z-10"
//                           >
//                             <GrPrevious />
//                           </button>
//                           <button
//                             onClick={() => slideRefs.current.slickNext()}
//                             className="absolute top-1/2 right-5 transform -translate-y-1/2 text-gray-700 bg-white p-2 rounded-full z-10"
//                           >
//                             <GrNext />
//                           </button>
//                         </>
...
//                                   <div
//                                     key={nestedIndex}
//                                     className="shadow-lg mx-3 mt-4 mb-4"
//                                   >
