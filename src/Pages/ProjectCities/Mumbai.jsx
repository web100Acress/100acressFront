...
const Mumbai = () => {
  ...
  const mumbaiProject = useSelector(store => store?.stateproject?.mumbai);

  useEffect(() => {
    if (mumbaiProject.length === 0) {
  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        />
        <link rel="canonical" href="https://www.100acress.com/project-in-mumbai/" />
      </Helmet>
      ...
      <section className="flex pt-2 flex-col items-center mt-16">
        ...
        <h2 className="text-sm mb-4 text-center sm:text-xl md:text-xl lg:text-sm font-normal lg:mx-20 md:mx-10 mx-5 sm:mx-4 tracking-[0.1em]">
          Mumbai is witnessing transformational projects. Some major
          ...
          enhance urban living, and force economic growth in India's booming
          financial capital.
        </h2>
