...
const Sonipat = () => {
  ...
  const Sonipat = useSelector(store => store?.stateproject?.sonipat);
  ...
  return (
    <div>
      <Helmet>
        <title>
          Property in Sonipat - Flats, Villas, House for Sale in Sonipat
        </title>
        <meta
          name="description"
      ...
      <section className="flex pt-2 flex-col items-center mt-16">
        ...
        <h2 className="text-sm mb-4 text-center sm:text-xl md:text-xl lg:text-sm font-normal lg:mx-20 md:mx-10 mx-5 sm:mx-4 tracking-[0.1em]">
          Sonipat is transforming with major enterprises, including new housing
