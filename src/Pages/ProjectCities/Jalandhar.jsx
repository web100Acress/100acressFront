...
const Jalandhar = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Property in Jalandhar - Flats, Villas, House for Sale in Jalandhar
        </title>
        <meta
          name="description"
      ...
      <section className="flex pt-2 flex-col items-center mt-16">
        ...
        <h2 className="text-sm mb-4 text-center sm:text-xl md:text-xl lg:text-sm font-normal lg:mx-20 md:mx-10 mx-5 sm:mx-4">
          Jalandhar is transforming with major enterprises, including new housing
