            ...
            {searchData.map((item, index) => {
              ...
              return (
                <Link to={`/${pUrl}/`} target="_top" key={index}>
                  <article className="mb-4 transition hover:scale-105 bg-white overflow-hidden rounded-md border text-gray-700 shadow-md duration-500 ease-in-out hover:shadow-xl">
                    <div>
                      <img
