...
const ShopCumOfficePlotsGurgaon = () => {
  ...
  const customConfig = {
    ...config,
    title: 'Shop Cum Office Plots in Gurgaon',
    description: 'Discover Premium Shop Cum Office Plots in Gurgaon – Your Gateway to Commercial Investment and Business Growth.',
    h1: 'Shop Cum Office Plots in Gurgaon',
    breadcrumbs: [
      { label: 'Home', path: '/' },
      { label: 'Shop Cum Office Plots in Gurgaon', path: location.pathname }
    ]
  };
...
export default ShopCumOfficePlotsGurgaon;
