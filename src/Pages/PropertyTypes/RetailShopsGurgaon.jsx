...
const RetailShopsGurgaon = () => {
  ...
  const customConfig = {
    ...config,
    title: 'Retail Shops in Gurgaon',
    description: 'Discover Premium Retail Shops in Gurgaon – Your Gateway to Commercial Success and Prime Real Estate Investment.',
    h1: 'Retail Shops in Gurgaon',
    breadcrumbs: [
      { label: 'Home', path: '/' },
...
export default RetailShopsGurgaon;
