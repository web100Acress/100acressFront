...
//         <h3 className='text-center text-red-600 md:text-xl lg:text-2xl xl:text-4xl pt-4'>About 100acress.com</h3>
//         <p className='text-gray-500 text-lg  text-justify'>100acress.com Gurgaon is an honoured real estate company that strongly believes in providing customer
...
//             className="h-10 w-10 "
//           />
//           <h3 className="pt-1 text-red-600 text-lg md:text-xl sm:text-lg lg:text-2xl xl:text-3xl">Awards and Recognitions</h3>
//         </div>
//         <div>
//           <p className='text-gray-500 text-lg text-justify'>Our expert team is working on making secure and smooth all legal and mandatory transactions of our housing and commercial projects to
