  ...
  import { FaUserCircle, FaEnvelope, FaPhone, FaFileAlt, FaExclamationCircle, FaRobot } from 'react-icons/fa';
  ...
  const JobApplications = () => {
    ...
    const runAiScoring = async () => {
      ...
      try {
        ...
        // Re-fetch the applications to get the new scores
        fetchApplications();
      } catch (e) {
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center space-x-4">
                <button
                  ...
                  className="flex items-center px-4 py-2 rounded-md bg-blue-600 text-white hover:bg-blue-700 transition duration-300 disabled:bg-gray-400"
                >
                  <FaRobot className={`mr-2 ${scoring ? 'animate-spin' : ''}`} />
                  {scoring ? "Scoring..." : "Calculate AI Scores"}
                </button>
                <Link
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-3">
                          <div className="text-sm font-bold">{renderScore(a.matchScore)}</div>
                          {getStatusBadge(a.status)}
                        </div>
                      </div>
