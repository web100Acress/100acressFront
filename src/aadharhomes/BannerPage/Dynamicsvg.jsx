...
const normalizeText = (text) => text.toLowerCase().replace(/\s+/g, '_');


const Dynamicsvg = ({text}) => {

    const iconKey = normalizeText(text);
