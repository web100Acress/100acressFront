...
const FAQSectionMobile = ({ projectViewDetails = {}, onShowCallback = () => {} }) => {
  ...
  return (
    <section className="relative py-12 md:py-16 bg-gradient-to-b from-black via-gray-900 to-black text-white overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div 
          ...
          className="text-center mb-6 md:mb-8 mt-8 md:mt-0"
        >
          <motion.div 
                ...
                <div className="relative">
                  ...
                  <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-xl border border-gray-700/50 backdrop-blur-sm overflow-hidden">
                    ...
                    >
                      ...
                      <motion.div 
                        className={`flex-shrink-0 w-5 h-5 bg-gradient-to-br from-amber-500 to-amber-600 rounded-full flex items-center justify-center transition-transform duration-200 ${openIndex === index ? 'rotate-180' : ''}`}
        ...
        >
          <div className="relative group">
            ...
            <motion.div 
              className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-xl p-4 md:p-5 border border-gray-700/50 backdrop-blur-sm"
            ...
            >
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between space-y-3 md:space-y-0 md:space-x-6">
                ...
                <div className="flex items-start space-x-3 flex-1">
                  <motion.div 
                    className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-amber-500 to-amber-600 rounded-full flex items-center justify-center"
                  ...
                  <div>
                    <h4 className="text-white font-bold text-base md:text-lg mb-1">Still have questions?</h4>
                    <p className="text-gray-400 text-xs md:text-sm">We're here to help you with any queries about this project.</p>
                  </div>
                </div>
                ...
                <motion.button
                  ...
                  className="flex-shrink-0 bg-gradient-to-r from-amber-600 to-amber-500 text-black font-bold px-4 py-2 md:px-6 md:py-3 rounded-lg hover:from-amber-500 hover:to-amber-400 transition-all duration-300 transform hover:scale-105 flex items-center space-x-2 text-sm md:text-base"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
