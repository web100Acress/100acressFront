...
const FAQSectionMobile = ({ projectViewDetails = {}, onShowCallback = () => {} }) => {
    ...
    <section className="faq-section-mobile">
      ...
      <div className="faq-section-mobile-background">
        <div className="faq-section-mobile-background-overlay">
          <div className="faq-section-mobile-float-1"></div>
          <div className="faq-section-mobile-float-2"></div>
        </div>
        <div className="faq-section-mobile-gradient-overlay"></div>
      </div>

      <div className="faq-section-mobile-content">
        {/* Mobile Section Header */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="faq-section-mobile-header"
        >
          <motion.div 
            className="faq-section-mobile-header-icon"
          ...
          <h2 className="faq-section-mobile-subtitle">
            FREQUENTLY ASKED QUESTIONS
          </h2>
          <h3 className="faq-section-mobile-title">
            Everything You Need to Know
          </h3>
          <div className="faq-section-mobile-accent-line"></div>
        </motion.div>
        ...
        <motion.div 
          ...
          className="faq-section-mobile-faq-content"
        >
          <div className="faq-section-mobile-faq-list">
            {faqs.map((faq, index) => (
              <motion.div 
                key={index}
                ...
                className="faq-section-mobile-faq-item"
              >
                <div className="faq-section-mobile-faq-item">
                  {/* Glow Effect */}
                  <div className="faq-section-mobile-faq-glow"></div>
                  
                  <div className="faq-section-mobile-faq-card">
                    
                    {/* Question */}
                    <button
                      onClick={() => toggleFAQ(index)}
                      className="faq-section-mobile-question-button"
                    >
                      <h4 className="faq-section-mobile-question">
                        {faq.title}?
                      </h4>
                      <motion.div 
                        className={`faq-section-mobile-chevron ${openIndex === index ? 'open' : ''}`}
                    ...
                    {/* Answer */}
                    <motion.div 
                      className="faq-section-mobile-answer"
                      initial={false}
                      animate={{ height: openIndex === index ? 'auto' : 0 }}
                    >
                      <div className={`faq-section-mobile-answer-inner ${openIndex === index ? 'open' : ''}`}>
                        <div className="faq-section-mobile-divider"></div>
                        <p className="faq-section-mobile-answer-text">
                          {faq.content}
                        </p>
                      </div>
                    </motion.div>
        ...
        <motion.div 
          ...
          className="faq-section-mobile-cta"
        >
          <div className="faq-section-mobile-cta">
            {/* Glow Effect */}
            <div className="faq-section-mobile-cta-glow"></div>
            
            <motion.div 
              className="faq-section-mobile-cta-card"
              whileHover={{ scale: 1.02 }}
            >
              <div className="faq-section-mobile-cta-row">
                
                {/* Left Content */}
                <div className="faq-section-mobile-cta-left">
                  <motion.div 
                    className="faq-section-mobile-cta-icon"
                  ...
                  <div>
                    <h4 className="faq-section-mobile-cta-title">Still have questions?</h4>
                    <p className="faq-section-mobile-cta-subtitle">We're here to help you with any queries about this project.</p>
                  </div>
                </div>
                ...
                <motion.button
                  ...
                  className="faq-section-mobile-cta-button"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
