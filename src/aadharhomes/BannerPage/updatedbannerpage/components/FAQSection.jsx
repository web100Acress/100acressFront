      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto mt-8">
          <div className="relative group">
            ...
            <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-xl p-5 md:p-6 border border-gray-700/50 backdrop-blur-sm">
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between space-y-4 md:space-y-0 md:space-x-6">
                ...
                <div className="flex items-start space-x-3 flex-1">
                  ...
                  <div>
                    <h5 className="text-amber-400 font-bold mb-1.5 text-base">Still Have Questions?</h5>
