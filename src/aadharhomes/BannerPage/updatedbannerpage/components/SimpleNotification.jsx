...
const SimpleNotification = () => {
  ...
  const icon = notification.type === 'success' ? (
    <div className="simple-notification-icon success">
      <svg fill="currentColor" viewBox="0 0 20 20">
        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
      </svg>
    </div>
  ) : (
    <div className="simple-notification-icon error">
      <svg fill="currentColor" viewBox="0 0 20 20">
  ...
  return (
    <div className="simple-notification">
      <div className="simple-notification-content">
        <div className="simple-notification-icon-wrapper">
          {icon}
        </div>
        <div className="simple-notification-message">
          {notification.message}
        </div>
        <button
          onClick={() => setNotification(null)}
          className="simple-notification-close"
        >
          <svg fill="currentColor" viewBox="0 0 20 20">
