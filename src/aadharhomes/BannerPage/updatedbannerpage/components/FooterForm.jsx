          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="flex items-start space-x-4 p-4 bg-gray-800/30 rounded-xl border border-gray-700/50">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1">100% Secure</h4>
              ...
              <div className="flex items-start space-x-4 p-4 bg-gray-800/30 rounded-xl border border-gray-700/50">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Get callback within 5 minutes</p>
                </div>
              </div>
              
              <div className="flex items-start space-x-4 p-4 bg-gray-800/30 rounded-xl border border-gray-700/50">
                <div className="flex-shrink-0 w-12 h-12 bg-amber-500/10 rounded-lg flex items-center justify-center">
                  <i className="fa-solid fa-users text-amber-400 text-xl"></i>
                </div>
                <div>
                  <h4 className="text-white font-semibold mb-1">Expert Guidance</h4>
                  <p className="text-gray-400 text-sm">Certified property consultants</p>
                </div>
              </div>
              
              <div className="flex items-start space-x-4 p-4 bg-gray-800/30 rounded-xl border border-gray-700/50">
                <div className="flex-shrink-0 w-12 h-12 bg-purple-500/10 rounded-lg flex items-center justify-center">
                  <i className="fa-solid fa-star text-purple-400 text-xl"></i>
                </div>
                <div>
                  <h4 className="text-white font-semibold mb-1">Premium Service</h4>
                  <p className="text-gray-400 text-sm">Exclusive property deals & insights</p>
                </div>
              </div>
            </div>
